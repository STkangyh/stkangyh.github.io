...
const themeToggle: string = `<button id="theme" aria-label="Toggle colour theme">
...
export const themeScript: string = `<script>(function(){var r=document.documentElement,K='hp_mode';
...
export function renderHeader({ site, base }: { site: Site; base: string }): string {
